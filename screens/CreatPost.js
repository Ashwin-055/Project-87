...
export default class CreateStory extends Component {
  ...
  render() {
    ...
    return (
      <View style={[styles.container,{backgroundColor:this.state.light_theme ? "white" : "#15193c"}]}>
        ...
        <View style={styles.appTitle}>
          ...
          <View style={styles.appTitleTextContainer}>
            <Text style={[styles.appTitleText,{color:this.state.light_theme ? "black" : "white"}]}>New Post</Text>
          </View>
        </View>
          ...
          <ScrollView>
            <View
              ...
              <DropDownPicker
                  ...
                  style={{ backgroundColor: "transparent", borderColor: this.state.light_theme ? "black" : "white" }}
                  itemStyle={{
            ...
            <TextInput
              style={[styles.inputFont,{borderColor: this.state.light_theme ? "black" : "white"}]}
